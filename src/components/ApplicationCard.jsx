            ...
            <CardContent>
                <div className='flex flex-col md:flex-row justify-between'>
                    <div className='flex items-center gap-2'>
                        <BriefcaseBusiness size={16} /> {application.experience} years of experience</div>
                    <div className='flex items-center gap-2'><School size={16} />{application.education} </div>
                    <div className='flex items-center gap-2'> <Boxes size={16} />{application.skills}</div>
                </div>
                <hr />
            </CardContent>
