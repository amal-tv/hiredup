...
export async function getJobs(token, { location, company_id, searchQuery }) {
    ...
    if (error) {
        console.error("error while fethcing the jobs", error);
        return null;
...
export async function addNewJob(token, _, jobData) {
    ...
    if (error) {
        console.error("error creating the jobs", error);
        return null;
    }
...
export async function getSavedJobs(token) {
    ...
    if (error) {
        console.error("error fetching the saved jobs", error);
        return null;
    }
...
export async function getMyJobs(token, { recruiter_id }) {
    ...
    if (error) {
        console.error("error fetching the My jobs", error);
        return null;
    }
...
export async function deleteJobs(token, { job_id }) {
    ...
    if (error) {
        console.error("error deleting the My jobs", error);
        return null;
    }
